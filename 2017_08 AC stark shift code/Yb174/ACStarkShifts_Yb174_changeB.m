function [AC_diff_1, AC_diff_end, abs_shift_up, abs_shift_down] = ACStarkShifts_Yb174_changeB( spl )
...
% --- see how changing B affects the splitting.
...
% % ss = 1;                       % for example
% % pp = sqrt(1-2*ss^2);            % for example  %%%%%% why 1 - 2*ss^2?
